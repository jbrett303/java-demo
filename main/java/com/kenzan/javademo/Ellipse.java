...
public class Ellipse extends Shapes implements flatShape {
	...
	/**
	 * Ellipse
	 * instantiates a squished circle aka ellipse
	...
	/**
	 * getArea will return the area of the ellipse in whatever dimension type it was instantiated with.
	...
	private static double getPerimeter(double radiusOne, double radiusTwo){
		return PI * (3 * (radiusOne + radiusTwo) - Math.sqrt((3 * radiusOne + radiusTwo)*(radiusOne + 3 * radiusTwo)));
	}
}
